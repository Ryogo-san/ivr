...
class PGD(Attack):
    def __init__(self,model,device,cfg,steps=5,eps=0.3,alpha=2/255):
    ...
    def forward(self,images,labels):
        ...
        for _ in range(self.steps):
            ...
            grad=torch.autograd.grad(loss,adv_images,retain_graph=False,create_graph=False,allow_unused=True)[0]
